    ...
    \subsubsection{Results} \label{sec:cs_results}
      ...
      \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{|L{1}|L{1}|} \hline
          \cellcolor[gray]{0.8} \textbf{Products} & $3,668$ \\\hline
          \cellcolor[gray]{0.8} \textbf{Positive opinions} & $2,111$ \\\hline
          \cellcolor[gray]{0.8} \textbf{Negative opinions} & $4,360$ \\\hline
          \cellcolor[gray]{0.8} \textbf{Prices} & $10,259$ \\\hline
          \cellcolor[gray]{0.8} \textbf{Stop and function words} & $1,085$ \\\hline
          \cellcolor[gray]{0.8} \textbf{Non-keyword \textquote{words}} & $468,532$ \\\hline
        \end{tabularx}
        \label{tab:words}
